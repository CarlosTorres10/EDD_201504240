...
namespace ABBTree
{
    public class NodoArbolABB {
        ...
        public void insertar(IComparable Usuario, String Contra, String Email, int Conexion)
        {
        ...
        public void graficar(String path)
        {
            ...
            try
            {
                fichero = new StreamWriter("Arbol_Usuario_Espejo.dot");
            ...
            try
            {
                ...
                startInfo.Arguments = "dot -Tpng -o" + path + " Arbol_Usuario_Espejo.dot";
                Process.Start(startInfo);
                Process.Start("Arbol_Usuario_Espejo.png");
